...
def page_task6():
    ...
    use_xgb = c3.checkbox("Use XGB (please run this if installed)", value=True)
    st.warning(
        "XGBoost models should be run locally (offline) rather than via the Streamlit web app, "
        "as their computational requirements may exceed the free compute limits of Streamlit online."
        "If you are using a web browser to open this, please do not check the box; leave it unchecked."
    )
